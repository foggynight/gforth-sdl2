...
\ ----===< prefix >===-----
c-library sdl_test_assert
s" SDL2" add-lib
\c #include <SDL2/SDL_stdinc.h>
\c #include <SDL2/SDL_test_assert.h>

\ ----===< int constants >===-----
#0	constant ASSERT_FAIL
#1	constant ASSERT_PASS
...
c-function SDLTest_Assert SDLTest_Assert n a ... -- void	( assertCondition assertDescription <noname> -- )
c-function SDLTest_AssertCheck SDLTest_AssertCheck n a ... -- n	( assertCondition assertDescription <noname> -- )
c-function SDLTest_AssertPass SDLTest_AssertPass a ... -- void	( assertDescription <noname> -- )
c-function SDLTest_ResetAssertSummary SDLTest_ResetAssertSummary  -- void	( -- )
c-function SDLTest_LogAssertSummary SDLTest_LogAssertSummary  -- void	( -- )
c-function SDLTest_AssertSummaryToTestResult SDLTest_AssertSummaryToTestResult  -- n	( -- )
